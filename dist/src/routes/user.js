...
routes.get("/library/save/:idmovie", checkAuth_1.checkAuth, USER.saveToLibrary);
routes.get("/library/unsave/:idmovie", checkAuth_1.checkAuth, USER.unsaveToLibrary);
routes.get("/library/check/:idmovie", checkAuth_1.checkAuth, USER.checkSave);
routes.post("/password/change", checkAuth_1.checkAuth, USER.changePassword);
routes.get("/name/change/:newname", checkAuth_1.checkAuth, USER.changeName);
